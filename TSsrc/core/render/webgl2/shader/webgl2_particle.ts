...
export default class Webgl2Particle {
    ...
    private vertexAttributeName4: string;
    private vertexAttributeName5: string;
    private vertexAttributeName6: string;
    private vertexAttributeName7: string;
    private vertexAttributeName8: string;
    private vertexAttributeName9: string;
    private vertexAttributeName10: string;
    private matViewProjUniformName: string;
    private matWorldUniformName: string;
    private curTimeUniformName: string;
    private imageUniformName: string;
    /**用于着色器调试输出的纹理 */
    private fontImageUniformName: string;

    private matViewProjUniformIndex: WebGLUniformLocation;
    private matWorldUniformIndex: WebGLUniformLocation;
    private curTimeUniformIndex: WebGLUniformLocation;
    ...
    private glFontTexture: WebGLTexture;
    ...
    public setUniformAttribute(matViewProj: Float32List, matWorld: Float32List, curTime: number): void {
