...
export class ParticleBatchModel {
    ...
    private maxParticleCount: number = 100;
    ...
    private readonly vertexAttriFloatCount: number = 19;
    private readonly createTimeOffset: number = 12;
    private readonly lifeTimeOffset: number = 11;

    private curParticleCount: number = 0;

    public addParticleVertexData(particle: Particle): boolean {
    ...
    private _tempParticle: Particle;
    public getFreeParticle(): Particle {
